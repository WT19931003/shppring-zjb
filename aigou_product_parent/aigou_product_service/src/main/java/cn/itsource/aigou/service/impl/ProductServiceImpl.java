...
public class ProductServiceImpl extends ServiceImpl<ProductMapper, Product> implements IProductService {
    ...
    private Map<String,Object> getDetailPageMap(Product product) {
        ...
        map.put(AiGouConstants.PAGE_MODEL,detailDataMap);
        map.put(AiGouConstants.PAGE_TEMPLATEFILEPATHANDNAME,"E:\\ideaworkspace\\aigou_parent\\aigou_common_parent\\aigou_common_interface\\src\\main\\resources\\template\\product-detail.vm");
        map.put(AiGouConstants.PAGE_TARGETFILEPATHANDNAME,"E:\\ideaworkspace\\vue_parent\\aigou_home\\"+product.getId()+".html");
        return map;
    }
